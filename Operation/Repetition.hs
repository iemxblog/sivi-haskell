...
next :: Double 		-- ^ z_safe : Tool retraction 
	-> Operation	-- ^ op1 : First operation
	 -> Operation	-- ^ op2 : Second operation
	 -> Operation	-- Rectraction + Operation 1 + Retraction + Operation 2
...
circularRepetition :: Double		-- ^ d : Diameter 
			...
			-> Operation	-- ^ op : Operation to repeat
			-> Operation	-- ^ Retraction + Operation 1 on circle + Retraction + Operation 2 on circle + ...
...
gridRepetition :: Int		-- ^ nx : Number of repetitions on X axis
		 ...
		 -> Double	-- ^ z_safe : Tool retraction
		 -> Operation	-- ^ op : Operation to repeat
		 -> Operation	-- ^ Retraction + Operation 1 on grid + Retraction + Operation 2 on grid + ...
