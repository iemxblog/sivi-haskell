...
next :: Double 			-- ^ z_safe : Tool retraction 
	-> Operation Program	-- ^ op1 : First operation
	 -> Operation Program	-- ^ op2 : Second operation
	 -> Operation Program	-- Rectraction + Operation 1 + Retraction + Operation 2
next z_safe o1 o2 = retract z_safe +++ o1 +++ retract z_safe +++ o2 

repetition :: [V3 Double] -> Double -> Operation Program -> Operation Program
...
circularRepetition :: Double			-- ^ d : Diameter 
			...
			-> Operation Program	-- ^ op : Operation to repeat
			-> Operation Program	-- ^ Retraction + Operation 1 on circle + Retraction + Operation 2 on circle + ...
...
gridRepetition :: Int			-- ^ nx : Number of repetitions on X axis
		 ...
		 -> Double		-- ^ z_safe : Tool retraction
		 -> Operation Program	-- ^ op : Operation to repeat
		 -> Operation Program	-- ^ Retraction + Operation 1 on grid + Retraction + Operation 2 on grid + ...
